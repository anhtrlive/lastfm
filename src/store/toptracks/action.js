...
export const getTopTracks = (numberPage = 1) => async (dispatch) => {
  const res = await axios.get(`https://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&page=${numberPage}&limit=49&api_key=e9527c6687e8c2f070da3f3c0e5b6881&format=json`)
